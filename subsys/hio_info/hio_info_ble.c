...
LOG_MODULE_REGISTER(hio_info_ble, CONFIG_HIO_INFO_LOG_LEVEL);
...
BT_GATT_SERVICE_DEFINE(
	...
	BT_GATT_CHARACTERISTIC(
		...
		pass_str, NULL, hio_info_get_vendor_name
	),
	...
	BT_GATT_CHARACTERISTIC(
		...
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ_AUTHEN,
		pass_str, NULL, hio_info_get_product_name
	),
	...
	BT_GATT_CHARACTERISTIC(
		...
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ_AUTHEN,
		pass_str, NULL, hio_info_get_hw_variant
	),
	...
	BT_GATT_CHARACTERISTIC(
		...
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ_AUTHEN,
		pass_str, NULL, hio_info_get_hw_revision
	),
	...
	BT_GATT_CHARACTERISTIC(
		...
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ_AUTHEN,
		pass_str, NULL, hio_info_get_fw_name
	),
	...
	BT_GATT_CHARACTERISTIC(
		...
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ_AUTHEN,
		pass_str, NULL, hio_info_get_fw_version
	),
	...
	BT_GATT_CHARACTERISTIC(
		...
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ_AUTHEN,
		pass_str, NULL, hio_info_get_serial_number
	),
	...
	BT_GATT_CHARACTERISTIC(
		...
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ_AUTHEN,
		pass_str, NULL, hio_info_get_claim_token
	),
	...
	BT_GATT_CHARACTERISTIC(
		...
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ_AUTHEN,
		pass_str, NULL, hio_info_get_ble_devaddr
	),
	...
	BT_GATT_CHARACTERISTIC(
		...
		BT_GATT_CHRC_READ,
		BT_GATT_PERM_READ_AUTHEN,
		pass_str, NULL, hio_info_get_ble_passkey
	),
);
