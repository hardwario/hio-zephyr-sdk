...
#ifndef SUBSYS_HIO_LTE_TOK_H_
#define SUBSYS_HIO_LTE_TOK_H_
 ...
 */
const char *hio_lte_tok_pfx(const char *s, const char *pfx);
 ...
 */
const char *hio_lte_tok_sep(const char *s);
 ...
 */
const char *hio_lte_tok_end(const char *s);
 ...
 */
const char *hio_lte_tok_str(const char *s, bool *def, char *str, size_t size);
 ...
 * @return      Pointer to the next position in the string after the token.
 */
const char *hio_lte_tok_num(const char *s, bool *def, long *num);
 ...
 * @return      Pointer to the next position in the string after the token.
 */
const char *hio_lte_tok_float(const char *s, bool *def, float *num);

#ifdef __cplusplus
}
#endif

#endif /* SUBSYS_HIO_LTE_TOK_H_ */
